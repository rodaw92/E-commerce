...
function productListReducer(state={products:[]}, action)
{
    switch(action.type){
        case PRODUCT_LIST_REQUEST:
            return { loading: true, products: [] };// means i will show a loading box in this
        case PRODUCT_LIST_SUCCESS:  //means I get the data from the server
...
function productDetailsReducer(state={product:{}}, action)
{
    switch(action.type){
        ...
        case PRODUCT_DETAILS_SUCCESS:  //means I get the data from the server
